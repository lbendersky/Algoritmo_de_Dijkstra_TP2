...
import imp.Dijkstra_forma1;
import imp.Dijkstra_forma1.Dijkstra;
...
public class prin_forma1 {
	...
	public static void main(String[] args) {
		...
		GrafoTDA a = new Dijkstra_forma1();
		a.inicializarGrafo();
		a.agregarVertice(1);
		a.agregarVertice(2);
		a.agregarVertice(3);
		...
		GrafoTDA copia = new Dijkstra_forma1();
		...
		GrafoTDA grafoReducido = Dijkstra.primerMetodo(1, copia);
		System.out.println(" ");
		System.out.println("Matriz de adyacencia resultante, después de implementar el 1er método de Dijkstra: ");
