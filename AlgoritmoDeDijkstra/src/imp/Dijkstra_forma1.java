...
public class Dijkstra_forma1 implements GrafoTDA {
    ...
    public class Dijkstra {
        ...
        public static Dijkstra_forma2 primerMetodo(int origen, GrafoTDA grafo) { // Implementación del algoritmo de Dijkstra
        ...
        private static boolean todosVisitados(ConjuntoTDA vertices, boolean[] visitado) { // Verifica si todos los vértices del conjunto se visitaron.
        ...
        private static int verticeMinDistNoVisitado(ConjuntoTDA vertices, int[] distancias, boolean[] visitado) { // Devuelve el vértice no visitado con menor distancia.
